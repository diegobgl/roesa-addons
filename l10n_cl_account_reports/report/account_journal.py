...
class journal_invoice_print(report_sxw.rml_parse):
    ...
    def lines(self, period_id, journal_id=False):
        ...
        return obj_ainvoice.browse(self.cr, self.uid, ids)
...
class report_salepurchasejournal(osv.AbstractModel):
    _name = 'report.l10n_cl_account_reports.report_salepurchasejournal'
    #_inherit = 'report.abstract_report'
    #_template = 'l10n_cl_account_reports.report_salepurchasejournal'
    _wrapped_report_class = journal_invoice_print
    
class report_salejournal(osv.AbstractModel):
    _name = 'report.l10n_cl_account_reports.report_salejournal'
    #_inherit = 'report.abstract_report'
    #_template = 'l10n_cl_account_reports.report_salepurchasejournal'
    _wrapped_report_class = journal_invoice_print
